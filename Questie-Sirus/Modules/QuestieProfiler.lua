...
function QuestieProfiler:CreateUI()
    ...
    statusLabel:SetPoint("BOTTOMLEFT", base, 10, 10)
    statusLabel:Show()
    base.lastIndex = 0
    ...
    button:SetPoint("TOPLEFT", base, 10, -10)
    button:SetWidth(80)
    button:SetHeight(24)
    ...
    button:SetPoint("TOPLEFT", base, base:GetWidth() - 70, -10)
    button:SetWidth(60)
    button:SetHeight(24)
    ...
    button = CreateFrame("Button", nil, base)
    button:SetPoint("TOPLEFT", base, 90, -10)
    button:SetWidth(140)
    button:SetHeight(24)
    ...
    local searchBox = CreateFrame("Frame", nil, base, BackdropTemplateMixin and "BackdropTemplate")
    searchBox:SetPoint("TOPLEFT", base, 260, -10)
    searchBox:SetWidth(192)
    ...
    local search = CreateFrame("EditBox", nil, searchBox, BackdropTemplateMixin and "BackdropTemplate" or nil)
    search:SetMultiLine(false)
    search:SetFontObject(ChatFontNormal)
    search:SetWidth(180)
    search:SetHeight(20)
    search:SetFrameStrata("TOOLTIP")
    search:SetPoint("TOPLEFT", searchBox, 6, -1)
