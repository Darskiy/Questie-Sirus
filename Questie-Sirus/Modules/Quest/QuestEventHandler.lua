...
function _QuestEventHandler:InitQuestLog()
    ...
    -- if cacheMiss then
        ...
        --Questie:Error("Did you accept a quest during InitQuestLog? Please report on GitHub. Game's quest log cache is not ok. This shouldn't happen. Questie may malfunction.")
    -- end
