...
function _ZoneDB:RunTests()
    ...
    Questie:Debug(Questie.DEBUG_CRITICAL, "[" .. Questie:Colorize("ZoneDBTests", Questie.COLORS.YELLOW) .. "] Testing ZoneDB")
    local buggedMaps = {
    ...
    Questie:Debug(Questie.DEBUG_CRITICAL, "[" .. Questie:Colorize("ZoneDBTests", Questie.COLORS.YELLOW) .. "] Testing ZoneDB done")
end
